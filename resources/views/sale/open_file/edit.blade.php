...
@section('content')
    ...
    @endphp
    <form id="open_file_edit" class="open_file_edit" action="{{isset($url)?$url:""}}" method="post" enctype="multipart/form-data" autocomplete="off">
        @if(!$data['view'])
            @csrf
            @method('patch')
        @endif
...
@section('pageJs')
    <script src="{{ asset('/pages/sale/open_file/edit.js') }}"></script>
