...
@section('content')
    ...
    <form id="installment_plan_create" class="installment_plan_create" action="{{route('sale.installment-plan.store')}}" method="post" enctype="multipart/form-data" autocomplete="off">
        <input type="hidden" id="form_type" value="installment_plan">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body mt-2">
                        <div class="row">
                            ...
                            <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm" id="installemnt_plan_name" name="installemnt_plan_name"  aria-invalid="false" >
                                    </div>
                                </div>
                            <div class="mb-1 row">
                                    <div class="col-sm-3">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number"  class="form-control form-control-sm" id="total_payment" name="total_payment" aria-invalid="false">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control form-control-sm FloatValidate" id="down_payment" name="down_payment" aria-invalid="false">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control form-control-sm FloatValidate" id="on_balloting" name="on_balloting" aria-invalid="false">
                                        </div>
                                    </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control form-control-sm FloatValidate" id="allocation_amount" name="allocation_amount">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control form-control-sm FloatValidate" id="installment_bi_annual" name="installment_bi_annual">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control form-control-sm FloatValidate" id="installment_monthly" name="installment_monthly">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
...
@section('pageJs')
    ...
    <script src="{{ asset('/pages/sale/installment_plan/create.js') }}"></script>
    @yield('pageJsScript')
@endsection
                    ...
                    success: function(response,data) {
                        if(response.status == 'success'){
                            ...
                            for (const input_item in input_variations) {
                                ...
                                variations_list += '<div class="col-sm-3">\n' +
