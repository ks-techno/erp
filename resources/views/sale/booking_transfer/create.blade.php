...
@section('content')
    @permission($data['permission'])
        ...
        @endphp
        <form id="booking_transfer_create" class="booking_transfer_create" action="{{ route('sale.booking-transfer.store') }}"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body mt-2 new_member_and_nominee">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="col-form-label p-0">Entry Date: <span
                                        ...
                                        <div class="col-sm-4">
                                            <div class="col-sm-12">
                                                <div class="form-check form-check-primary form-switch">
                                                    <input type="checkbox" class="form-check-input" id="booking_transfer_status"
                                                        name="status" checked>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="col-sm-12 mb-1">
                                        ...
                                        <div class="input-group eg_help_block">
                                            ...
                                            <input id="customer_name" type="text" name="nm_customer_name"
                                                class="customer_name nm_customer_name form-control form-control-sm text-left">
                                    ...
                                    <div class="mb-1 row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="hidden" class="form-control form-control-sm nm_membership_no"
                                                value="" id="nm_membership_no_input" name="nm_membership_no" />
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="hidden" class="form-control form-control-sm cnic" value=""
                                                id="nm_cnic_no_input" name="nm_cnic_no" />
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="hidden" class="text-start form-control form-control-sm NumberValidate"
                                                value="" id="nm_mobile_no_input" name="nm_mobile_no" />
                                    ...
                                    <div class="mb-1 row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="hidden" class="form-control form-control-sm" value=""
                                                id="nm_nominee_name_input" name="nm_nominee_name" />
                                    ...
                                    <div class="mb-1 row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="hidden"
                                                ...
                                                id="nm_nominee_contact_no_input" name="nm_nominee_contact_no" />
                                            <p class="col-form-label nm_nominee_contact_no p-0 txt_color "></p>
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="col-form-label p-0">CNIC No# </label>
                                            <input type="hidden" class="form-control form-control-sm cnic" value=""
                                                id="nm_nominee_cnic_no" name="nm_nominee_cnic_no" />
                                ...
                                <div class="col-sm-4">
                                    <div class="col-sm-12 mb-1">
                                        ...
                                        <div style="position: relative;">
                                            <a onclick="document.getElementById('nm_showImage').src='{{ $img }}'"
                                                class="close AClass" id="nm_resetInput">
                                                <span class="img_remove">&times;</span>
                                            </a>
                                            <img id="nm_showImage" class="mb-1" src="{{ $img }}"
                                                style="width: 100px; height: 90px; float: {{ session()->get('locale') == 'ar' ? 'left' : 'right' }};">
                                        </div>
                                        <input class="form-control form-control-sm" type="file"
                                            value="{{ $img }}" id="nm_image_url" name="nm_image" />
                                    </div>
                        ...
                        <div class="card-body booking_list">
                            ...
                            <div class="mt-2 row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group checklist-item">
                                        <input type="checkbox" id="cvt" name="cvt">
                                        <label for="cvt">Capital Value Type (CVT)</label>
                                    </div>
                                </div>

                                <div class="col-sm-4">
                                    <div class="form-group checklist-item">
                                        <input type="checkbox" id="advanceTax" name="advanceTax">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group checklist-item">
                                        <input type="checkbox" id="gainTax" name="gainTax">
                                        <label for="gainTax">Gain Tax</label>
                                    </div>
                                </div>
                            ...
                            <div class="mt-2 row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group checklist-item">
                                        <input type="checkbox" id="withholdingTax" name="withholdingTax">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group checklist-item">
                                        <input type="checkbox" id="tmaFiler" name="tmaFiler">
                                        <label for="tmaFiler">TMA (Filer)</label>
                                    </div>
                                </div>
                            ...
                            <div class="mt-2 row">
                                <div class="col-sm-4">
                                    <div class="form-group checklist-item">
                                        <input type="checkbox" id="tmaNonFiler" name="tmaNonFiler">
                                        <label for="tmaNonFiler">TMA (Non Filer)</label>
                                    </div>
                                </div>

                                <div class="col-sm-4">
                                    <div class="form-group checklist-item">
                                        <input type="checkbox" id="societyFees" name="societyFees">
                                        <label for="societyFees">Society Fees</label>
                                    </div>
                                </div>
                            </div>
