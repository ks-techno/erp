...
@endphp
<form id="refund_file_create" class="refund_file_create" action="{{route('sale.refund-file.store')}}" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body transfer_process">
                    <h3>Refund/Merge File Process</h3>
                    <div class="row">
                        <div class="col-sm-4">
