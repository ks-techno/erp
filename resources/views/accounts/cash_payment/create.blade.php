...
@section('content')
    ...
    <form id="cash_payment_create" class="cash_payment_create" action="{{route('accounts.cash-payment.store')}}" method="post" enctype="multipart/form-data" autocomplete="off">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
...
@endsection
@section('pageJs')
    <script src="{{ asset('/pages/accounts/cash_payment/create.js') }}"></script>
@endsection
