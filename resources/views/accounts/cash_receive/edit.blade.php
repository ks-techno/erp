...
@section('content')
    ...
    @php
        ...
        if(!$data['view']){
            $url = route('accounts.cash-receive.update',$data['id']);
        }
    @endphp
    <form id="cash_receive_edit" class="cash_receive_edit" action="{{isset($url)?$url:""}}"  method="post" enctype="multipart/form-data" autocomplete="off">
        @if(!$data['view'])
            @csrf
            @method('patch')
        @endif
                                                   ...
                                                   $formatted_credit = number_format($dtl->credit, 2); // Format with 2 decimal places
                                                    ...
                                                    @endphp
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input data-id="egt_debit" type="text" name="pd[{{$loop->iteration}}][egt_debit]" value="{{ $formatted_debit }}" class="FloatValidate debit form-control form-control-sm">
                                                            </td>
                                                            <td>
                                                                <input data-="egt_credit" type="text" name="pd[{{$loop->iteration}}][egt_credit]" value="{{ $formatted_credit}}" class="FloatValidate credit form-control form-control-sm">
                                                            </td>
                                                            <td class="text-center">
...
@endsection
@section('pageJs')
    <script src="{{ asset('/pages/accounts/cash_receive/edit.js') }}"></script>
@endsection
