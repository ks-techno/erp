...
@section('content')
    ...
    @endphp
    <form id="bank_receive_edit" class="bank_receive_edit" action="{{route('accounts.bank-receive.update',$data['id'])}}" method="post" enctype="multipart/form-data" autocomplete="off">
        @csrf
        @method('patch')
        <div class="row">
            <div class="col-12">
