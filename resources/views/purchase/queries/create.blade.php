...
@section('content')
    ...
    @endphp
    <form id="refund_file_create" class="refund_file_create" action="{{ route('sale.refund-file.store') }}" method="post"
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body mt-2 new_member_and_nominee">
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-2">
                                <label class="col-form-label p-0">Launch Query:</label>
                            </div>


                            <div class="col-sm-3">
                                <select class="select2 form-select" id="file_type2" name="file_type2">
                                    <option value="" selected>Select Value</option>
                                    <option data-slug="Manual" value="Manual"> Manual</option>
                                    <option data-slug="Accounts" value="Accounts"> Accounts </option>
                                    <option data-slug="Audit" value="Audit"> Audit</option>
                                    <option data-slug="Admin" value="Admin"> Admin</option>
                                    <option data-slug="Record" value="Record"> Record</option>
                                    <option data-slug="Other" value="Other"> Other</option>
                                </select>
                            </div>

                            <div class="col-sm-2">
                                <label class="col-form-label p-0">Query Date:<span class="required">*</span></label>
                            </div>
                            <div class="col-sm-3">
                                <input type="text" id="entry_date" name="date" class="form-control form-control-sm"
                                    value="{{ date('d-m-Y', strtotime($entry_date)) }}" />
                            </div>
                        </div>
                        ...
                        {{-- Forward  --}}
                         ...
                         <div class="row mt-2">
                            ...
                            <div class="col-sm-2">
                                <label class="col-form-label p-0">Forwarded To:</label>
                            </div>

                            <div class="col-sm-3">
                                <select class="select2 form-select" id="file_type3" name="file_type3">
                                    <option value="" selected>Select Value</option>
                                    <option data-slug="CR" value="CR"> CR</option>
                                    <option data-slug="Accounts" value="Accounts"> Accounts </option>
                                    <option data-slug="Audit" value="Audit"> Audit</option>
                                    <option data-slug="Admin" value="Admin"> Admin</option>
                                    <option data-slug="Record" value="Record"> Record</option>
                            ...
                            <div class="col-sm-2">
                                <label class="col-form-label ">Forward Date:<span class="required">*</span></label>
                            </div>
                            <div class="col-sm-3">
                                <input type="text" id="entry_date2" name="date2" class="form-control form-control-sm"
                                    value="{{ date('d-m-Y', strtotime($entry_date)) }}" />
                            </div>
                        </div>
                        ...
                        {{-- <div class="row mt-2">
                                <div class="col-sm-4">
                                    <label class="col-form-label p-0">Remarks:</label>
                                </div>
                                <div class="col-sm-8">
                                    <div class="col-sm-12">
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-2">
                                <label class="col-form-label p-0">Action Taken:</label>
                            </div>

                            <div class="col-sm-3">
                                <select class="select2 form-select" id="file_type" name="file_type">
                                    <option value="" selected>Select Value </option>
                                    <option data-slug="Approved" value="Approved"> Approved</option>
                                    <option data-slug="Notapproved" value="Notaprroved"> Not Approved </option>
                                    <option data-slug="Pending" value="Pending"> Pending</option>
                                </select>
                            </div>

                            <div class="col-sm-2">
                                <label class="col-form-label p-0"> Date of Action:<span class="required">*</span></label>
                            </div>
                            <div class="col-sm-3">
                                <input type="text" id="entry_date1" name="date1" class="form-control form-control-sm"
                                    value="{{ date('d-m-Y', strtotime($entry_date)) }}" />
                            </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-2">
                                <label class="col-form-label p-0">Query Location<span class="required">*</span></label>
                            </div>

                            <div class="col-sm-3">

                                <input type="text" class="form-control form-control-sm text-left sellerList"
                                    id="booking_name" name="booking_name">
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-4">
                                <div class="col-sm-12 mb-1">
                                    ...
                                    <div class="input-group eg_help_block">
                                        <span class="input-group-text" id="om_addon_remove"><i
                                                data-feather='minus-circle'></i></span>
                                        <input id="om_customer_name" name="om_customer_name" type="text"
                                            class="om_customer_name form-control form-control-sm text-left">
                                        <input id="om_customer_id" type="hidden" class="om_customer_id"
                                            name="om_customer_id">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="hidden" class="form-control form-control-sm om_membership_no"
                                            value="" id="om_membership_no_input" name="om_membership_no" />
                                        <p class="col-form-label om_membership_no p-0 txt_color"></p>
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="col-form-label p-0">CNIC No#</label>
                                        <input type="hidden" class="form-control form-control-sm cnic" value=""
                                            id="om_cnic_no" name="om_cnic_no" />
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="hidden"
                                            class="text-start form-control form-control-sm NumberValidate" value=""
                                            id="om_mobile_no_input" name="om_mobile_no" />
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="mb-1 row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="hidden" class="form-control form-control-sm" value=""
                                            id="om_nominee_name_input" name="om_nominee_name" />
                                ...
                                <div class="mb-1 row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="hidden"
                                            class="text-start form-control form-control-sm NumberValidate" value=""
                                            id="om_nominee_contact_no_input" name="om_nominee_contact_no" />
                                        <p class="col-form-label om_nominee_contact_no p-0 txt_color"></p>
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="col-form-label p-0">CNIC No# </label>
                                        <input type="hidden" class="form-control form-control-sm cnic" value=""
                                            id="om_nominee_cnic_no" name="om_nominee_cnic_no" />
                            ...
                            <div class="col-sm-4">
                                ...
                                <div style="position: relative;">
                                    <a onclick="document.getElementById('om_showImage').src='{{ $img }}'"
                                        class="close AClass" id="om_resetInput">
                                        <span class="img_remove">&times;</span>
                                    </a>
                                    {{-- @dd($img); --}}
                                    <img id="om_showImage" class="mb-1" src="{{ $img }}"
                                        style="width: 100px; height: 90px; float: {{ session()->get('locale') == 'ar' ? 'left' : 'right' }};">
                                </div>
                                <input class="form-control form-control-sm" type="file" id="om_image_url"
                                    name="om_image" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="row mb-3">
                                <div class="col-sm-4">
                                    <div class="mb-1 row">
                                        <div class="col-sm-12">
                                            <label class="col-form-label p-0">Booking List <span
                                                    class="required">*</span></label>
                                            <input type="text"
                                                class="form-control form-control-sm text-left sellerList"
                                                id="booking_name" name="booking_name">
                                            <input type="hidden" id="booking_id" name="booking_id">
                                            <div id="sellerTable"></div>
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-1 row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="hidden" class="form-control form-control-sm" value=""
                                                id="property_payment_mode_id" name="property_payment_mode_id" />
                                            <input type="hidden" class="form-control form-control-sm" value=""
                                                id="om_booking_code_input" name="booking_code" />
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="hidden" class="form-control form-control-sm" value=""
                                                id="om_product_name_input_id" name="product_id" />
                                            <input type="hidden" class="form-control form-control-sm" value=""
                                                id="om_product_name_input_name" name="product_name" />
                                    ...
                                    <div class="mb-1 row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="hidden" class="form-control form-control-sm" value=""
                                                id="om_file_status_input_id" name="file_status_id" />
                                            <p class="col-form-label om_file_status p-0 txt_color"></p>
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="col-form-label p-0">Registration Number</label>
                                            <input type="hidden" class="form-control form-control-sm" value=""
                                                id="om_external_item_id_input_id" name="external_item_id" />
                                            <input type="hidden" class="form-control form-control-sm" value=""
                                                id="om_external_item_id_input_name" name="external_item_id" />
                                ...
                                <div class="col-sm-4">
                                    <div class="col-sm-6 mb-1">
                                        ...
                                        <input type="hidden" class="form-control form-control-sm" value=""
                                            id="om_booked_price_input_id" name="booked_price" />
                                        <input type="hidden" class="form-control form-control-sm" value=""
                                            id="om_booked_price_input_name" name="booked_price" />
                                        <p class="col-form-label om_booked_price p-0 txt_color"></p>
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="col-form-label p-0">Currency Note</label>
                                        <input type="hidden" class="form-control form-control-sm" value=""
                                            id="om_currency_note_no_input_id" name="currency_note_no" />
                                        <input type="hidden" class="form-control form-control-sm" value=""
                                            id="om_currency_note_no_input_name" name="currency_note_no" />
    ...
    <div class="modal fade right" id="createNewCustomer" tabindex="-1" aria-labelledby="exampleModalScrollableTitle"
...
@section('script')
    ...
    <script>
        ...
        var entry_date1 = $('#entry_date1');
        if (entry_date1.length) {
            entry_date1.flatpickr({
                dateFormat: 'd-m-Y',
            });
        }
        var entry_date2 = $('#entry_date2');
        if (entry_date2.length) {
            entry_date2.flatpickr({
                dateFormat: 'd-m-Y',
            });
        }
                ...
                $.ajax({
                    ...
                    success: function(response, data) {
                        if (response.status == 'success') {
                            ...
                            table =
                                "<div class='table-wrapper'><table><thead><tr><th>Plot No.</th><th>Block</th></tr></thead><tbody>";
                            for (var i = 0; i < sales_length; i++) {
                                var products = sales[i].product;
                                var product_length = sales[i].product.length;
                                table += '<tr data-id="' + customer.sales[i]['id'] + '" data-name="' + customer
                                    .sales[i]['code'] + '"><td><b>' + sales[i].product.name +
                                    '</b></td><td><b>' + sales[i].product.block + '</b></td></tr>';
                ...
                $.ajax({
                    ...
                    success: function(response, data) {
                        if (response.status == 'success') {
                            ...
                            $('form').find('#property_payment_mode_id').val(sales
                            ...
                            $('form').find('#om_external_item_id_input_id').val(sales.product
                                .external_item_id);
                            $('form').find('#om_external_item_id_input_name').val(sales.product
                                .external_item_id);
                            ...
                            $('form').find('#om_currency_note_no_input_name').val(sales
                                .currency_note_no);
