...
@section('content')
    ...
    @endphp
    <form id="manufacturer_edit" class="manufacturer_edit" action="{{route('purchase.manufacturer.update',$data['id'])}}" method="post" enctype="multipart/form-data" autocomplete="off">
        @csrf
        @method('patch')
        <div class="row">
            <div class="col-12">
