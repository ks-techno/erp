var url = '/help/chart';
var id = 'ch_chart_code';

$(document).on('change','#ch_chart_code',function(e){
    ...
    $('#ch_chart_name').val(chart_name);
    $('#ch_chart_name1').val(chart_name);
    $('#ch_chart_code1').val(chart_code);
    $('#ch_chart_code').val(chart_code);
...
//             $('.ch_form_header_input').find('.chart_code').val(chart_code);
//             $('.ch_form_header_input').find('.chart_name').val(chart_name);
//             $('.ch_form_header_input').find('.chart_id').val(chart_id);
