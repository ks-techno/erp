...
class LcpController extends Controller
{
    ...
    private static function Constants()
    {
        $name = 'user';
        return [
            'title' => 'Lead Comission Policy',
            'list_url' => route('setting.lcp.index'),
            'list' => "$name-list",
            'create' => "$name-create",
            'edit' => "$name-edit",
            'delete' => "$name-delete",
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            foreach ($allData as $row) {
                ...
                $urlEdit = route('setting.lcp.edit',$row->uuid);
                $urlDel = route('setting.lcp.destroy',$row->uuid);
        ...
        return view('setting.lcp.list', compact('data'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('setting.lcp.create', compact('data'));
    }
