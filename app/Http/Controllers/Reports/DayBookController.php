...
use Validator;
use PDF;
use App\Exports\DayBookDataExport;
...
class DayBookController extends Controller
{
    private static function Constants()
    {
        ...
        return [
            'type' => "BPV",
            'title' => 'Day Book',
            'list_url' => route('reports.day-book.index'),
            'list' => "$name-list",
            'create' => "$name-create",
            'edit' => "$name-edit",
            'delete' => "$name-delete",
     ...
     public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            foreach ($allData as $row) {
                ...
                $urlEdit = route('reports.ledgers.edit',$row->voucher->voucher_id);
                $urlDel = route('reports.ledgers.destroy',$row->voucher->voucher_id);
                $urlPrint = route('reports.ledgers.print',$row->voucher->voucher_id);
        ...
        return view('reports.day_book.list', compact('data'));
    }
    ...
    public function exportPDF(Request $request)
    {
        ...
        $allData = $dataSql->get();
         ...
         $pdf = PDF::loadView('reports.ledgers.pdf', compact('data'));
    ...
    public function exportExcel(Request $request)
{
    ...
    public function create()
    {
      ...
      //  $data['payment_mode'] = PaymentMode::where('status',1)->get();
        return view('reports.ledgers.create', compact('data'));
    }
